...
install.bat
```
* This "hopefully" auto-detects your AMD gpu and installs the correct ROCM & pytorch packages, I only have an RX6800 and obviously cannot test other AMD GPU's. Regarding older RDNA1, I am going to try to add them later.
