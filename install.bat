...
if /I "!arch!"=="gfx1201" (
    echo %GREEN%[*]%RESET% Installing sage-attention native gfx1201 ...
    .\python_env\python.exe -m pip install --force-reinstall --no-deps "https://github.com/thehybrid1337/sageattention-rocm-gfx1201-win/releases/download/v2.2.0-rocm10.2-20260921/sageattention-2.2.0-cp312-cp312-win_amd64.whl" %QQ%
) else (
...
.\python_env\python.exe -m pip install https://github.com/0xDELUXA/bitsandbytes_win_rocm/releases/download/0.50.2.dev0-py3.12-rocm7.16-win_amd64_all/bitsandbytes-0.50.2.dev0-cp312-cp312-win_amd64.whl %QQ%
if errorlevel 1 goto :install_failed
